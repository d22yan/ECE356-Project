 ...
 * @author root
 */
@WebServlet(name = "AssignPatient", urlPatterns = {"/AssignPatient"})
public class AssignPatient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("doctorId") != null) {
            ...
            Database.Manager.clearAssignedPatient(doctorId);
            for (String patientId : patientIdList) {
                if (!patientId.equals("null")) {
                    Database.Manager.addAssignedPatient(doctorId, Integer.parseInt(patientId));
                }
            }
